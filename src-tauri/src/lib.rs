...
pub fn run(argv: argv::ArgV) {
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            business::user_database::canvas::command::color_list::user_database_canvas_color_list,
            ...
            business::user_database::canvas::command::move_canvas::user_database_canvas_move_canvas,
            ...
            business::user_database::canvas::command::set_color::user_database_canvas_set_color,
            ...
            business::user_database::node::command::move_node::user_database_node_move_node,
            ...
            business::user_database::node::command::color_list::user_database_node_color_list,
            business::user_database::node::command::search::user_database_node_search,
            business::user_database::node::command::set_color::user_database_node_set_color,
