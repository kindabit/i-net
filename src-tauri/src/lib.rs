...
pub fn run(argv: argv::ArgV) {
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            business::metadata::command::archive::metadata_archive,
            business::metadata::command::list::metadata_list,
            business::metadata::command::physical_delete::metadata_physical_delete,
            business::metadata::command::register::metadata_register,
            business::metadata::command::save::metadata_save,
            business::preference::command::get::preference_get,
            business::preference::command::set::preference_set,
            ...
            business::user_database::attachment::command::list_orphan_files::user_database_attachment_list_orphan_files,
            ...
            business::user_database::canvas::command::physical_delete::user_database_canvas_physical_delete,
            business::user_database::canvas::command::rename::user_database_canvas_rename,
            business::user_database::canvas::command::restore::user_database_canvas_restore,
            business::user_database::canvas::command::set_color::user_database_canvas_node_set_color,
            business::user_database::dictionary::command::list::user_database_dictionary_list,
            business::user_database::dictionary::command::set::user_database_dictionary_set,
            ...
            business::user_database::lifecycle::command::initialize::user_database_lifecycle_initialize,
            ...
            business::user_database::node::command::list::user_database_node_list,
            business::user_database::node::command::list_bookmarked::user_database_node_list_bookmarked,
            business::user_database::node::command::logical_delete::user_database_node_logical_delete,
            business::user_database::node::command::modify::user_database_node_modify,
            business::user_database::node::command::move_nodes::user_database_node_move_nodes,
            business::user_database::node::command::physical_delete::user_database_node_physical_delete,
            business::user_database::node::command::relocate_nodes::user_database_node_relocate_nodes,
            business::user_database::node::command::restore::user_database_node_restore,
            business::user_database::node::command::color_list::user_database_data_node_color_list,
            business::user_database::node::command::search::user_database_node_search,
            business::user_database::node::command::set_bookmarked::user_database_node_set_bookmarked,
            business::user_database::node::command::set_color::user_database_data_node_set_color,
            business::user_database::node_field::command::get::user_database_node_field_get,
            business::user_database::node_field::command::set::user_database_node_field_set,
            business::user_database::node_tag::command::list::user_database_node_tag_list,
            business::user_database::node_tag::command::list_for_node::user_database_node_tag_list_for_node,
            business::user_database::node_tag::command::list_nodes::user_database_node_tag_list_nodes,
            business::user_database::node_tag::command::set_for_node::user_database_node_tag_set_for_node,
            business::user_database::template::command::create::user_database_template_create,
            business::user_database::template::command::create_from_node::user_database_template_create_from_node,
            business::user_database::template::command::delete::user_database_template_delete,
            business::user_database::template::command::export::user_database_template_export,
            business::user_database::template::command::get_fields::user_database_template_get_fields,
            business::user_database::template::command::import::user_database_template_import,
            business::user_database::template::command::list::user_database_template_list,
            business::user_database::template::command::rename::user_database_template_rename,
            business::user_database::template::command::set_fields::user_database_template_set_fields,
            business::user_database::registry::command::get::user_database_registry_get,
            business::user_database::registry::command::set::user_database_registry_set,
            business::user_database::viewport::command::get::user_database_viewport_get,
            business::user_database::viewport::command::set::user_database_viewport_set,
        ])
        .setup(move |_app| {
